...
// Note: We need to make these functions public or create a test module in src/api/app_id.rs
// For now, we'll test via the public calculate_app_id function
// If we need to test calculate_hmac directly, we would need to expose it
